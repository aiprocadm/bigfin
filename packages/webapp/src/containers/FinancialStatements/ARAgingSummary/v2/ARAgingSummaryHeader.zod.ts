...
/**
 * Схема формы настройки отчёта «Дебиторка по срокам» (замена Yup-схемы
 ...
 */
export const getARAgingSummaryHeaderSchema = () => {
...
export type ARAgingSummaryHeaderFormValues = z.infer<
  ReturnType<typeof getARAgingSummaryHeaderSchema>
>;
