...
> Фаза 3 (УПД, статус 1, альбомная ориентация через `landscape: true`,
> эндпоинт `GET /ru-print-forms/sale-invoices/:id/upd`; упрощения: без кода
> вида товара, акциза, страны происхождения, грузоотправителя/грузополучателя,
> идентификатора госконтракта) — следующий PR.
> Фаза 4 — ТОРГ-12 + Счёт-фактура отдельно.
