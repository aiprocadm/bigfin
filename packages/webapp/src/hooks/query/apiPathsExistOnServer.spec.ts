...
const KNOWN_DEBT: Record<string, string> = {
  // ПУСТО, и это не «пока никто не смотрел». 19.09 все три оставшиеся
  // строки разобраны: за каждой стоял МЁРТВЫЙ код, зовущий ручку, которой
  // на сервере нет вовсе. Список организаций, оплата подписки старым
  // способом и создание «представлений» таблиц — ни одну из этих функций
  // не вызывал никто. Они удалены, а не «исправлены»: чинить вызов туда,
  // куда никто не ходит, значит чинить ловушку для следующего.
};
