 ...
 */
// Модуль проектов, живший здесь единственным исключением, закрыт целиком
// (Р3 карты v16, вопрос 31): маршрут удалён, страница разваливалась —
// серверных ручек projects/* не существует ни одной.
