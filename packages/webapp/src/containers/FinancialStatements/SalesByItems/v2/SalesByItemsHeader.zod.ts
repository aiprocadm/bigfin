...
/**
 * Схема формы настройки отчёта «Продажи по позициям» (замена Yup-схемы
 ...
 */
export const getSalesByItemsHeaderSchema = () =>
  z
    .object({
      dateRange: z.string(),
      fromDate: z.date({
...
export type SalesByItemsHeaderFormValues = z.infer<
  ReturnType<typeof getSalesByItemsHeaderSchema>
>;
