...
describe('навигация: у каждого модуля есть пункт меню', () => {
  ...
  it('мёртвого раздела «Проекты» больше нет в маршрутах (вопрос 31)', () => {
    // Раздел открывался по прямой ссылке и разваливался: серверных ручек
    // projects/* не существует ни одной. Решение владельца (поручение
    // «прими сам наиболее эффективное решение»): маршрут закрыт, файлы
    // страниц не удалены — их удаление отдельное решение.
