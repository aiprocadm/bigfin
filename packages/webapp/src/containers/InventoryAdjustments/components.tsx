 ...
 * Publish accessor
 */
export const PublishAccessor = (r: any) => {
 ...
 */
export const TypeAccessor = (row: any) => {
 ...
 * Item type accessor.
 */
export const ItemCodeAccessor = (row: any) =>
  row.type ? (
    <Tag minimal={true} round={true} intent={Intent.NONE}>
      {intl.get(row.type)}
    </Tag>
 ...
 */
export const QuantityOnHandCell = ({ cell: { value } }: any) => {
 ...
 * Cost price cell.
 */
export const CostPriceCell = ({ cell: { value } }: any) => {
 ...
 * Sell price cell.
 */
export const SellPriceCell = ({ cell: { value } }: any) => {
  return !isBlank(value) ? <Money amount={value} currency={'USD'} /> : null;
};
 ...
 * Item type accessor.
 */
export const ItemTypeAccessor = (row: any) => {
  return row.type ? (
    <Tag minimal={true} round={true} intent={Intent.NONE}>
      {intl.get(row.type)}
    </Tag>
  ...
  return React.useMemo(
    () => [
      ...
      },
      {
        ...
        accessor: (r: any) => moment(r.created_at).format('YYYY MMM DD'),
        width: 125,
