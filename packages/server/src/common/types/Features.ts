export enum Features {
  ...
  DOCUMENTS = 'documents',
  /**
   * ИИ-аналитик: текстовые выводы по уже посчитанным агрегатам (этап 13 ТЗ).
   * По умолчанию ВЫКЛЮЧЕН — прямое требование §13.1: раздел обращается к
   * внешней модели, и включать такое за человека нельзя.
   */
