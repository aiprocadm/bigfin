...
const GUARDED_ELSEWHERE: string[] = [
  ...
  // AI CFO (FT-102): POST из-за длинного вопроса, ничего не меняет; данные
  // берутся запросами к отчётам с правами самого человека.
  'AiCfo/AiCfo.controller.ts#ask',
  // Оценка записки пишется только в журнал действий — данных не меняет.
  'AiCfo/AiCfo.controller.ts#rate',
