...
export class ManagementArticle extends TenantBaseModel {
  ...
  /**
   * Ярус управленческого ОПиУ (FT-009 ТЗ-3): выручка, прямые переменные,
   * административные… Домен — `utils/plTypes.ts`. `null` у дочерней статьи —
   * «как у родителя», у корневой — «не отнесено к ярусу».
   */
  plType!: string | null;
